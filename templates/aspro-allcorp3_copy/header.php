...
<body
   class="<?= ($bIndexBot ? "wbot" : "") ?> site_<?= SITE_ID ?> <?= ($bIncludedModule ? CAllcorp3::getConditionClass() : '') ?>"
   id="main" data-site="<?= SITE_DIR ?>">
<div class="bx_areas"><? if ($bIncludedModule) {
      CAllcorp3::ShowPageType('header_counter');
   } ?></div>
   ...
   <div role="main" class="main banner-auto">
      <? if (!$isIndex && !$is404 && !$isForm): ?>
         ...
         <? if ($APPLICATION->GetProperty("HIDETITLE") !== 'Y'): ?>
            ...
            <? if ($splitUrl[1] == 'services' && count($splitUrl) == 5) { ?>
      ...
      <div
         class="container <?= ($isCabinet ? 'cabinte-page' : ''); ?><?= ($isBlog ? ' blog-page' : ''); ?> <?= CAllcorp3::ShowPageProps("ERROR_404"); ?>">
         <? if (!$isIndex): ?>
         <div class="row">
            ...
            <div class="maxwidth-theme">
               ...
               <div class="col-md-12 col-sm-12 col-xs-12 content-md">
                  ...
                  <div class="col-md-12 col-sm-12 col-xs-12 content-md">
                     <div
                        class="right_block narrow_<?= CAllcorp3::ShowPageProps("MENU"); ?> <?= $APPLICATION->ShowViewContent('right_block_class') ?>">
