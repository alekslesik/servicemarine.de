...
<div class="company-item <?=$templateName?>-template">
	...
	if ($videoSource == 'LINK' ? strlen($videoSrc) : strlen($videoFileSrc)) {
		...
		if (strlen($videoSrc) && $videoSource === 'LINK') {
			...
			// RUTUBE:
			// <iframe width="720" height="405" src="//rutube.ru_/play/embed/10314281" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowfullscreen></iframe>
			...
			switch ($videoSrc) {
				case (($v = strpos($videoSrc, 'vimeo.com/')) !== false):
					...
					break;
				case (($v = strpos($videoSrc, 'rutube.ru_/')) !== false):
					$videoPlayer = 'RUTUBE';
					break;
